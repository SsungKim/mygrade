...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
                ...
                <div class="page_inner">
                    <div class="main_header">
                        ...
                        <div class="main_search_wrap">
							<div class="all_view">
								<span onclick="location.href='/exam'">전체보기</span>
							</div>
                    ...
                    <div class="page_select_wrap">
                    	<c:import url="/WEB-INF/view/exam/page.jsp"/>
                    </div>
                </div>
            </div>
            <footer>
    ...
    <script>
    	...
    	$(document).ready(function(){
    		if(${login.id != 'admin' }){
	    		alert('고2(예비고3) 학생들을 위한 오픈시기는 2017년 11월 16일입니다.\n(시기는 변동될 수 있습니다.)');
	    		location.href='/';
	    		return;
    		}
    	});
		...
		// 보기 페이지 이동
		function view(num, user){
			if(${login == null}){
				alert("로그인 후 이용가능합니다.");
				location.href='/member/login';
				return;
			}
			location.href='/exam/view/'+num;
		}
		// 검색
		function search(){
    		...
    		if(searchTxt != "" && searchTxt2 != ""){
    			location.href="/exam/search/both/"+searchTxt+"/"+searchTxt2;
    			return;
    		}
    		if(searchTxt != "" && searchTxt2 == ""){
    			location.href="/exam/search/school/"+searchTxt;
    			return;
    		}
    		if(searchTxt == "" && searchTxt2 != ""){
    			location.href="/exam/search/subject/"+searchTxt2;
    			return;
    		}
		}
		// 입력창에서 엔터
