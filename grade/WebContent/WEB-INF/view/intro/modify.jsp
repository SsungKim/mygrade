...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
    ...
    <body>
        <div id="wrapper">
        	<form action="/intro/modifyIntro" id="introForm" method="post">
        		<input type="hidden" name="auto" value="${intro.auto }"/>
	            <div class="intro02">
	                ...
	                <c:import url="/WEB-INF/view/admin/uploadIntroModify.jsp"/>
	                ...
	                <div class="page_inner" id="introDivWrap">
	                    ...
	                    <div class="txtarea_wrap">
                            ...
                            <div class="txta_wrap">
	                           ...
	                           <textarea placeholder="내용을 입력하세요." id="content1" maxlength="1000" name="content1">${intro.content1 }</textarea>
                            </div>
	                    </div>
                        <div class="iw_tit1">
                            <div class="img">
	                    ...
	                    <div class="txtarea_wrap">
                            ...
                            <div class="txta_wrap">
	                           ...
	                           <textarea placeholder="내용을 입력하세요." id="content2" maxlength="1500" name="content2">${intro.content2 }</textarea>
                            </div>
	                    </div>
                        <div class="iw_tit1">
                            <div class="img">
	                    ...
	                    <div class="txtarea_wrap">
                            ...
                            <div class="txta_wrap">
	                           ...
	                           <textarea placeholder="내용을 입력하세요." id="content3" maxlength="1000" name="content3">${intro.content3 }</textarea>
                            </div>
	                    </div>
                        <div class="iw_tit1">
                            <div class="img">
	                    ...
	                    <div class="txtarea_wrap txtarea_wrap4">
                            ...
                            <div class="txta_wrap">
                                ...
                                <input type="text" placeholder="질문을 입력하세요." id="title" maxlength="100" name="title" value="${intro.title }">
	                           <textarea class="txta1" placeholder="내용을 입력하세요." id="content4" maxlength="1500" name="content4">${intro.content4 }</textarea>
                            </div>
	                    </div>
