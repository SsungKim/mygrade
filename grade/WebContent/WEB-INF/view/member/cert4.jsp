...
<c:set var="phoneNo" value="<%= phoneNo %>"/>
<c:set var="phoneCorp" value="<%= phoneCorp %>"/>
...
<script>
	$(document).ready(function(){
		...
		if(${result == 'Y'}){
			$.ajax({
				type : "post",
				url : "/member/join2/${name }/${birthDay }/${phoneNo }/${phoneCorp }/${gender }/${result }",
				async : false,
				success : function(){
					if (UserAgent.match(/iPhone|iPod|Android|Windows CE|BlackBerry|Symbian|Windows Phone|webOS|Opera Mini|Opera Mobi|POLARIS|IEMobile|lgtelecom|nokia|SonyEricsson/i) != null || UserAgent.match(/LG|SAMSUNG|Samsung/) != null) {
						location.href="/member/join2";
					} else {
						opener.parent.location = "/member/join2";
						window.close();
					}
				}
			});
// 			opener.parent.location = "/member/join2/${name }/${birthDay }/${phoneNo }/${phoneCorp }/${gender }/${result }";
// 			window.close();
		}
	});
</script>
...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
	...
	<body>
		<br><br>
            ...
            <br>
            <br>
            <a href="http://www.mygrade.co.kr/member/cert1">[다시 테스트]</a>
	</body>
</html>
<%
    }catch(Exception ex){
