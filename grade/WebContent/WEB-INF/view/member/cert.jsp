...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
    ...
    <body bgcolor="#FFFFFF" topmargin=0 leftmargin=0 marginheight=0 marginwidth=0>
        <center>
            ...
            <form name="reqForm" method="post" action="/member/cert2">
                <table cellpadding=1 cellspacing=1>
                    <tr>
                        <td align=center>회원사ID</td>
                        <td align=left><input type="text" name="cpId" size='41' maxlength ='10' value = "${certId }"></td>
                    </tr>
                    <tr>
                        <td align=center>URL코드</td>
                        <td align=left><input type="text" name="urlCode" size='41' maxlength ='6' value="${code }"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align=left><input type="text" name="tr_url" size="41" value="http://www.mygrade.co.kr/member/cert3"></td>
                    </tr>
                    <tr>
