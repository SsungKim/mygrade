...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
            ...
            <div class="notice03">
                ...
                <div class="page_inner">
                    ...
                    <section class="section01">
                        ...
                        <div class="board_tit">
                            <div class="txt" id="titleDiv">
                            	<c:choose>
                            		<c:when test="${view.title.length() > 50 }">
                        ...
                        <div class="board_btn_wrap">
                        	<div class="board_btn" onclick="location.href='/free'">목록</div>
    ...
    <script>
    	// 글 수정
    	function modify(){
    		location.href="/free/modify/${view.auto }";
    	}
    	// 글 삭제
    	function remove(){
