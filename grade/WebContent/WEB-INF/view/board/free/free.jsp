	                ...
	                <div class="contents">
	                    <section class="contents_tit">
	                        ...
	                        <div class="tit">
                                ...
                                <span class="sel" onclick="location.href='/free'">자유게시판</span>
	                        </div>
	                    </section>
	                    <section class="section01">
	                        ...
	                        <c:if test="${login != null}">
                                <div class="write_btn" onclick="location.href='/free/write'">
                                    <div class="txt">글쓰기</div>
                                </div>
	                        </c:if>
                            <div class="page_select_wrap">
                                <c:import url="/WEB-INF/view/board/free/page.jsp"/>
                            </div>
	                    </section>
	                </div>
	            </div>
