...
<html oncontextmenu='return false' ondragstart='return false' onselectstart='return false'>
            ...
            <div class="notice03">
                ...
                <div class="page_inner">
                    ...
                    <section class="section01">
                        ...
                        <div class="add_file">
							<label>첨부파일</label>
							<div class="dataName" onclick="fileDown('${view.uuid }')">${view.fileName }</div>
						</div>
                        <div class="board_btn_wrap">
                        	<div class="board_btn" onclick="location.href='/info'">목록</div>
    ...
    <script>
    	// 글 수정
    	function modify(){
    		location.href="/info/modify/${view.auto }";
    	}
    	// 글 삭제
    	function remove(){
    	...
    	// 첨부파일 다운
    	function fileDown(uuid){
    		location.href='/info/fileDown?uuid='+uuid;
    	}
    </script>
