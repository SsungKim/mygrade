            ...
            <div class="notice02">
                ...
                <div class="page_inner">
                    ...
                    <section class="section01">
                    	<form action="/info/write2" method="post" enctype="multipart/form-data" id="infoForm">
                    		<input type="hidden" name="name" value="${login.id }"/>
	                        <div class="board_tit">
	                            <div class="tit">제목</div>
	                            <input type="text" name="title" placeholder="제목 입력란" id="title" maxlength="50">
	                        </div>
							<textarea placeholder="내용을 입력해주세요" name="content" id="content"></textarea>
							<div class="add_file">
								<label for="infoFile">첨부파일</label>
								<input type="file" id="infoFile" class="upload_hidden" name="infoFile" onchange="dataChange(this)">
								<input type="text" id="dataName" disabled="disabled"/>
							</div>
	                        <div class="btn_wrap">
...
//     			$.ajax({
//     				type : "post",
//     				url : "/info/write/"+title+"/"+content+"/${login.id }",
//     				async : false,
//     				success : function(txt){
//     					if(txt){
//     						alert("등록되었습니다.");
